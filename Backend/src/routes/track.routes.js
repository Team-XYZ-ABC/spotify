...
import { updateTrackSchema, uploadTrackSchema } from "../validators.js";
...
trackRouter.post("/artist/upload/track", isAuthenticated, authRole(["artist"]), validate(uploadTrackSchema), uploadTrack);
trackRouter.get("/artist/my-tracks", isAuthenticated, authRole(["artist"]), getMyTracks);
trackRouter.patch("/artist/:trackId", isAuthenticated, authRole(["artist"]), validate(updateTrackSchema), updateTrack);
