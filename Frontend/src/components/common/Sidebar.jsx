...
const Sidebar = ({
  ...
  return (
    <>
      ...
      >
        {/* Header */}
        <div className="px-4 py-4 flex items-center justify-between min-h-[72px]">
          {!isCollapsed && (
          ...
          <div className="flex items-center gap-2 shrink-0">
            ...
            {!isCollapsed && (
              <button className="bg-[#1f1f1f] h-8 w-8 rounded-full hover:bg-[#2a2a2a] flex items-center justify-center">
                +
              </button>
            )}
          </div>
