    ...
    <div className="flex-1 h-[calc(100vh-86px)] no-scrollbar overflow-y-auto bg-zinc-900 rounded-lg flex flex-col">
      <div className="bg-linear-to-b from-[#3a3a3a] to-black px-4 sm:px-6 md:px-10 py-8 sm:py-10">
        <div className="flex items-center gap-4 sm:gap-6">
          <div className="relative group w-24 h-24 sm:w-32 sm:h-32 md:w-40 md:h-40 bg-[#1f1f1f] rounded-full flex items-center justify-center shadow-lg cursor-pointer overflow-hidden">
            <i className="ri-user-line text-4xl sm:text-5xl text-gray-400"></i>
